const kpis = [
  { label: "Active Projects", value: "6", note: "Current delivery and program work requiring weekly visibility." },
  { label: "Projects At Risk", value: "1", note: "Riverside remains the clearest escalation case." },
  { label: "Open Field Issues", value: "23", note: "Most exposure sits inside watch-status work." },
  { label: "Closeout Overdue", value: "6", note: "Glenpark and Brookstone are driving turnover drag." },
...
const projects = [
  ...
  ["Summit Logistics Tenant Buildout", "General Contracting", "Active", "71%", "Healthy", "Startup sequencing needs review"],
...
const serviceSummary = [
  ...
  { title: "Northern Kentucky", meta: "6 open tickets | 2 in progress | 1 completed this week" }
];
...
const closeoutWarnings = [
  ...
  { title: "Brookstone Office Suite Modernization", meta: "4 open closeout items | training signoff overdue | vendor dependency open" },
